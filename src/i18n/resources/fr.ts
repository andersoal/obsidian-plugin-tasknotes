...
export const fr: TranslationTree = {
	...
	modals: {
		...
		timeEntryEditor: {
			...
			switchToTable: "Basculer vers la vue tableau",
			switchToForm: "Basculer vers la vue formulaire",
			tableHeaderDate: "Date",
			tableHeaderStart: "Début",
			tableHeaderEnd: "Fin",
			tableHeaderDuration: "Durée",
			tableHeaderDescription: "Description",
			tableRunning: "En cours",
			tableClickToEdit: "Cliquez sur une ligne pour développer et modifier",
			validation: {
