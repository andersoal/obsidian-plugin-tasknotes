		...
		taskProperties: {
			...
			taskPriorities: {
				...
				howTheyWork: {
					...
					value:
						'Valor: El identificador interno almacenado en tus archivos de tarea. Usa prefijos como "1-urgente", "2-alta" para controlar el orden de clasificación en las vistas de Bases.',
	...
	modals: {
		...
		taskEdit: {
			...
			buttons: {
				...
				editTimeEntries: "Editar registros de tiempo",
			},
			notices: {
				titleRequired: "Por favor ingresa un título de tarea",
		...
		timeEntryEditor: {
			...
			switchToForm: "Cambiar a vista de formulario",
			tableHeaderDate: "Fecha",
			tableHeaderStart: "Inicio",
			tableHeaderEnd: "Fin",
			tableHeaderDuration: "Duración",
			tableHeaderDescription: "Descripción",
			tableRunning: "En curso",
			tableClickToEdit: "Haga clic en la fila para expandir y editar",
			validation: {
