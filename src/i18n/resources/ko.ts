...
export const ko: TranslationTree = {
	...
	settings: {
		...
		appearance: {
			...
			taskFilenames: {
				...
				customTemplate: {
					name: "사용자 지정 파일명 템플릿",
					description: "사용자 지정 파일명 템플릿. 사용 가능한 변수: {title}, {titleLower}, {date}, {time}, {timestamp}, {zettel}, {priority}, {status}, {dueDate}, {scheduledDate}",
			...
			timeSettings: {
				...
				endTime: {
					name: "종료 시간",
					description: "타임라인 뷰에 표시되는 가장 늦은 시간 (HH:MM 형식)",
					placeholder: "22:00",
				},
				initialScrollTime: {
					name: "초기 스크롤 시간",
		...
		integrations: {
			basesIntegration: {
				...
				viewCommands: {
					...
					descriptionRegen: "설정을 변경해도 베이스 파일이 자동으로 업데이트되지 않습니다. 새 설정을 적용하려면 기존 .base 파일을 삭제하고 Obsidian을 다시 시작하거나, 아래 \"파일 생성\"을 사용하거나, 수동으로 편집하세요.",
	...
	modals: {
		...
		timeEntryEditor: {
			...
			switchToTable: "테이블 뷰로 전환",
			switchToForm: "폼 뷰로 전환",
			tableHeaderDate: "날짜",
			tableHeaderStart: "시작",
			tableHeaderEnd: "종료",
			tableHeaderDuration: "소요 시간",
			tableHeaderDescription: "설명",
			tableRunning: "실행 중",
			tableClickToEdit: "행을 클릭하여 펼쳐서 편집",
			validation: {
