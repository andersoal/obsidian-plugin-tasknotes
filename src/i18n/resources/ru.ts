		...
		taskProperties: {
			...
			taskPriorities: {
				...
				howTheyWork: {
					...
					value:
						'Значение: Внутренний идентификатор, хранящийся в файлах задач. Используйте префиксы вроде "1-срочный", "2-высокий" для управления порядком сортировки в представлениях Bases.',
